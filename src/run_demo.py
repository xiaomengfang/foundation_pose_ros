...
if __name__=='__main__':
  ...
  parser.add_argument('--mesh_file', type=str, default=f'{code_dir}/demo_data/tote_transfering/box2/mesh/box.obj')
  parser.add_argument('--test_scene_dir', type=str, default=f'{code_dir}/demo_data/tote_transfering/box2')
